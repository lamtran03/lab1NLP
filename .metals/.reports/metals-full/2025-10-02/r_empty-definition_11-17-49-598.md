error id: file:///D:/University/5_1_Subjects/NLP/Lab2/src/main/scala/lab2.scala:`<none>`.
file:///D:/University/5_1_Subjects/NLP/Lab2/src/main/scala/lab2.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/ml/feature/resultPath.
	 -org/apache/spark/ml/feature/resultPath#
	 -org/apache/spark/ml/feature/resultPath().
	 -org/apache/spark/sql/functions/resultPath.
	 -org/apache/spark/sql/functions/resultPath#
	 -org/apache/spark/sql/functions/resultPath().
	 -spark/implicits/resultPath.
	 -spark/implicits/resultPath#
	 -spark/implicits/resultPath().
	 -resultPath.
	 -resultPath#
	 -resultPath().
	 -scala/Predef.resultPath.
	 -scala/Predef.resultPath#
	 -scala/Predef.resultPath().
offset: 6337
uri: file:///D:/University/5_1_Subjects/NLP/Lab2/src/main/scala/lab2.scala
text:
```scala
...
object Lab17_NLPPipeline {
  def main(args: Array[String]): Unit = {
    ...
    println(s"Saved results to $result@@Path")
